...
/*! @name PIO0_16 (number 14), JOY
  @{ */
#define JOYSTICK_CHX_GPIO GPIO                 /*!<@brief GPIO device name: GPIO */
#define JOYSTICK_CHX_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define JOYSTICK_CHX_PIN 16U                   /*!<@brief PORT pin number */
#define JOYSTICK_CHX_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                               /* @} */

/*! @name PIO0_23 (number 20), JOY
  @{ */
#define JOYSTICK_CHY_GPIO GPIO                 /*!<@brief GPIO device name: GPIO */
#define JOYSTICK_CHY_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define JOYSTICK_CHY_PIN 23U                   /*!<@brief PORT pin number */
#define JOYSTICK_CHY_PIN_MASK (1U << 23U)      /*!<@brief PORT pin mask */
                                               /* @} */

/*! @name PIO0_15 (number 22), JOY
  @{ */
#define JOYSTICK_SW_INT_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define JOYSTICK_SW_INT_PIN 15U                   /*!<@brief PORT pin number */
#define JOYSTICK_SW_INT_PIN_MASK (1U << 15U)      /*!<@brief PORT pin mask */
                                                  /* @} */
 ...
 *
 */
void Joystick(void); /* Function assigned for the Cortex-M33 (Core #0) */
...
#define LCD_DC_GPIO_PIN_MASK (1U << 26U) /*!<@brief GPIO pin mask */
#define LCD_DC_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define LCD_DC_PIN 26U                   /*!<@brief PORT pin number */
#define LCD_DC_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                         /* @} */
...
#define LCD_RST_GPIO_PIN_MASK (1U << 27U) /*!<@brief GPIO pin mask */
#define LCD_RST_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define LCD_RST_PIN 27U                   /*!<@brief PORT pin number */
#define LCD_RST_PIN_MASK (1U << 27U)      /*!<@brief PORT pin mask */
                                          /* @} */
