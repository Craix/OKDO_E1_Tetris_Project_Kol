...
static void PINT_init(void) {
  ...
  PINT_PinInterruptConfig(PINT_PERIPHERAL, PINT_INT_0, kPINT_PinIntEnableFallEdge, SW_Callback);
  ...
  - fsl_lpadc:
    ...
    - IRQ_cfg:
      ...
      - adc_interrupt:
        ...
        - handler_custom_name: 'ADC_Callback'
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
static void ADC0_init(void) {
  ...
  LPADC_SetConvCommandConfig(ADC0_PERIPHERAL, ADC0_COMAND, &ADC0_commandsConfig[0]);
  /* Configure trigger 5. */
  LPADC_SetConvTriggerConfig(ADC0_PERIPHERAL, ADC0_TRIGGER, &ADC0_triggersConfig[0]);
