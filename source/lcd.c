...
static void LCD_InitReg(void){
	...
	//LCD_WriteData_8Bit(0x07); // 0000 0111
	LCD_WriteData_8Bit(0x00); // 0000 0111
	...
	LCD_WriteReg(0x36); //MX, MY, RGB mode 110110
	//LCD_WriteData_8Bit( 0x60);	//RGB color filter panel
	LCD_WriteData_8Bit( 0xC0);	//RGB color filter panel
	//110 0000
}
...
void colorStyle(bool rgb, bool inv)
{
	...
	{
		LCD_WriteReg(0x36); //MX, MY, RGB mode 110110
		LCD_WriteData_8Bit(0xC8);	//BRG color filter panel
